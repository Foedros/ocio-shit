...
export const LOGROS = [
  ...
  { id: 'LOG_CONSTANTE', nombre: 'Constante', rareza: 'raro', exp: 200, clase: 'habito',
    ...
    condicion_json: null, bloqueado_por: 'racha' },
  ...
  { id: 'LOG_ANIVERSARIO', nombre: 'Un año contigo', rareza: 'raro', exp: 200, clase: 'general',
    descripcion: 'Un año de archivo con actividad continua.', umbral: '1 año de actividad continua',
    condicion_json: null, bloqueado_por: 'antiguedad' },
  { id: 'LOG_CANON_NACE', nombre: 'Nace el canon', rareza: 'raro', exp: 150, clase: 'general',
    descripcion: 'Tu primer MomentoCanon destacado.', umbral: 'primer MomentoCanon.destacado',
    condicion_json: null, bloqueado_por: 'momentos' },
...
export const TITULOS = [
  ...
  { id: 'TIT_DECANO', nombre: 'Decano', rareza: 'legendario',
    descripcion: '5 años de archivo.', umbral: '5 años de archivo',
    condicion_json: null, bloqueado_por: 'antiguedad' },
  { id: 'TIT_CINEFILO', nombre: 'Cinéfilo', rareza: 'epico',
    descripcion: 'Tu clase principal es el cine.', umbral: 'clase principal = cine',
    condicion_json: null, bloqueado_por: 'clase' },
  { id: 'TIT_DEVORALIBROS', nombre: 'Devoralibros', rareza: 'epico',
    descripcion: 'Tu clase principal es el libro.', umbral: 'clase principal = libro',
    condicion_json: null, bloqueado_por: 'clase' },
  { id: 'TIT_GAMER', nombre: 'Gamer', rareza: 'epico',
    descripcion: 'Tu clase principal es el videojuego.', umbral: 'clase principal = juego',
    condicion_json: null, bloqueado_por: 'clase' },
  { id: 'TIT_GUARDIAN_CANON', nombre: 'Guardián del canon', rareza: 'epico',
    descripcion: '25 MomentoCanon registrados.', umbral: '≥ 25 MomentoCanon',
    condicion_json: null, bloqueado_por: 'momentos' },
  ...
  { id: 'TIT_SABIO', nombre: 'Sabio', rareza: 'epico',
    descripcion: 'Alcanza el nivel 20.', umbral: 'nivel ≥ 20',
    condicion_json: null, bloqueado_por: 'nivel' },
  ...
  { id: 'TIT_VETERANO', nombre: 'Veterano', rareza: 'epico',
    descripcion: '3 años de archivo.', umbral: '3 años de archivo',
    condicion_json: null, bloqueado_por: 'antiguedad' },
  { id: 'TIT_SERIEADICTO', nombre: 'Serieadicto', rareza: 'raro',
    descripcion: 'Tu clase principal es la serie.', umbral: 'clase principal = serie',
    condicion_json: null, bloqueado_por: 'clase' },
  { id: 'TIT_VINETISTA', nombre: 'Viñetista', rareza: 'raro',
    descripcion: 'Tu clase principal es el cómic.', umbral: 'clase principal = cómic',
    condicion_json: null, bloqueado_por: 'clase' },
  { id: 'TIT_EXPLORADOR', nombre: 'Explorador', rareza: 'raro',
    descripcion: 'Tu clase principal es el ocio libre.', umbral: 'clase principal = ocio libre',
    condicion_json: null, bloqueado_por: 'clase' },
  ...
  { id: 'TIT_ARQUITECTO', nombre: 'Arquitecto del dato', rareza: 'raro',
    descripcion: '100 obras con todos los campos ricos rellenos.', umbral: '≥ 100 obras "completas"',
    condicion_json: null, bloqueado_por: 'campos_ricos' },
  { id: 'TIT_COLECCIONISTA', nombre: 'Coleccionista', rareza: 'raro',
    descripcion: '25 colecciones creadas.', umbral: '≥ 25 colecciones',
    condicion_json: null, bloqueado_por: 'colecciones' }
];
